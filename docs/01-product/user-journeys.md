...
| Geography/service area | Receive requests the provider can actually serve. | Base location and service area use category-appropriate semantics. | Route/delivery/fixed-location model does not fit default; P02 category behavior required. |
